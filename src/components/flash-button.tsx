...
export function FlashButton({
  ...
  const modes = supportsTorch
    ? FLASH_MODES
    : FLASH_MODES.filter((m) => m !== "torch");
      ...
      {!expanded && (
        ...
        >
          ...
          >
            <ActiveIcon
              size={18}
              color={!supportsFlash ? "rgba(255,255,255,0.3)" : contrastColor}
            />
          </Pressable>
        </Animated.View>
      )}
          ...
          {modes.map((mode) => {
            ...
            return (
              ...
              >
                <Icon
                  size={18}
                  color={isCurrent ? contrastColor : "rgba(255,255,255,0.85)"}
                />
              </Pressable>
            );
          })}
